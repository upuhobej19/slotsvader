...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-d61b704d');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-d61b704d');}
...
function clearFlash(){dieView.classList.remove('rl-win-d61b704d');dieView.classList.remove('rl-lose-d61b704d');if(frameEl){frameEl.classList.remove('rl-win-d61b704d');frameEl.classList.remove('rl-lose-d61b704d');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-d61b704d');if(frameEl){frameEl.classList.add('rl-win-d61b704d');}}else{dieView.classList.add('rl-lose-d61b704d');if(frameEl){frameEl.classList.add('rl-lose-d61b704d');}}
...
var brandEl=document.querySelector('.rl-brand-d61b704d');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
